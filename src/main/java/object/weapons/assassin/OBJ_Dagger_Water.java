...
public class OBJ_Dagger_Water extends OBJ_Legendary_Dagger {
    GamePanel gp;
    public Projectile projectile1;
    public Projectile projectile2;
    public Projectile projectile3;
    public static final String objName = "Dagger Water";
    public OBJ_Dagger_Water(GamePanel gp, String element) {
        super(gp, element);
        this.gp = gp;
