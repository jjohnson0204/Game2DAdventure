...
public class OBJ_FireArrowSkill extends Projectile {
    GamePanel gp;
    Boolean fireOn = true;
    Player user;
    ...
    public  static final String objName = "Fire Arrow Skill";

    public OBJ_FireArrowSkill(GamePanel gp) {
        super(gp);
        this.gp = gp;
    ...
    private void getImage() {
        SpriteSheet sprite = new SpriteSheet("src/resources/projectile/firearrowskill.png", 32, 32, 9, 4);
        for (int i = 0; i < 9; i++) {
