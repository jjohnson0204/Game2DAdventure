...
public class OBJ_FireArrowBurst extends Projectile {
    GamePanel gp;
    Boolean fireOn = true;
    Player user;
    ...
    public  static final String objName = "Fire Arrow Burst";

    public OBJ_FireArrowBurst(GamePanel gp) {
        super(gp);
        this.gp = gp;
    ...
    private void getImage() {
        SpriteSheet sprite = new SpriteSheet("src/resources/projectile/firearrowburst.png", 32, 32, 9, 4);
        for (int i = 0; i < 9; i++) {
