...
public class OBJ_FireBlast extends Projectile {
    GamePanel gp;
    public  static final String objName = "Fire Blast";

    public OBJ_FireBlast(GamePanel gp) {
        super(gp);
        this.gp = gp;
    ...
    private void getImage() {
        SpriteSheet sprite = new SpriteSheet("src/resources/projectile/fireblast.png", 48,48,4,4);
